  ...
  return html`
    <div>
      <div className="header">
        ...
        ${wallet?.address && (wallet.portfolio != null || wallet.cash != null) &&
        html`<span className="wallet">
          <span>portfolio <b>${money(wallet.portfolio)}</b></span>
          <span>cash <b>${money(wallet.cash)}</b></span>
        </span>`}
      </div>
